            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        String saleid = modelList.get(position).getCart_id();
                        String store_order_id = modelList.get(position).getStore_order_id();
                        String userfullname = modelList.get(position).getUser_name();
                        String cart_id = modelList.get(position).getCart_id();
...
//                        intent.putExtra("time", time);
    ...
    public void onBindViewHolder(My_Nextday_Order_Adapter.MyViewHolder holder, int position) {
        ...
        holder.tv_ammount.setText( mList.getOrder_price()+context.getResources().getString(R.string.currency));
