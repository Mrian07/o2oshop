...
//        int items = (int) Double.parseDouble(dbcart.getInCartItemQty(map.get("varient_id")));
    ...
    private void updateMultiply(ProductHolder holder, HashMap<String, String> map) {
    ...
    class ProductHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, txt_close, tv_contetiy, iv_plus, iv_minus, pDescrptn, pQuan, pPrice, pdiscountOff, pMrp, tv_unit, tv_unit_value;
