...
//                    Use_Wallet_Ammont();
                    ...
                    Coupon_and_wallet.setVisibility(View.GONE);                            //was VISIBLE
                    Relative_used_wallet.setVisibility(View.GONE);                  //was VISIBLE
        ...
        checkBox_coupon.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Relative_used_coupon.setVisibility(View.GONE);                 //was VISIBLE
