...
//        }
    ...
    private void updateMultiply() {
        ...
        map.put("title", discription12);
        map.put("price", mrp12);
        map.put("deal_price", price12);
        ...
        try {
            ...
            if (items == 0) {
                ProdPrice.setText(getString(R.string.currency) + "" + price);
                prodMrp.setText(getString(R.string.currency) + "" + mrp);
            } else {
                ProdPrice.setText(getString(R.string.currency) + "" + price * items);
                prodMrp.setText(getString(R.string.currency) + "" + mrp * items);
            }
