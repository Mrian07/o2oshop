...
public class My_Pending_Order_adapter extends RecyclerView.Adapter<My_Pending_Order_adapter.MyViewHolder> {
    ...
    public My_Pending_Order_adapter(List<NewPendingOrderModel> modelList) {
        this.modelList = modelList;
    }
...
//                v.getContext().startActivity(intent);
        ...
        holder.canclebtn.setOnClickListener(v -> context.startActivity(new Intent(context.getApplicationContext(), Cancel_Order.class)));
