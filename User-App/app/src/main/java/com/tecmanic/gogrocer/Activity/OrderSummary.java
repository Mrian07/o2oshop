...
public class OrderSummary extends AppCompatActivity implements ForClicktimings {
    ...
    private  TextView textview_name_ofdata,textview_mobile_delivery,add_check_notice;
...
//        totalprice=String.valueOf(Integer.parseInt(DeliveryCharge.getText().toString())+Integer.parseInt(price.getText().toString()));
...
////        horizontalCalendar.selectDate(horizontalCalendar.getSelectedDate(),false);
//        todaydate= String.valueOf(DateFormat.format("yyyy-MM-dd",horizontalCalendar.getSelectedDate()));
//
...
//                todaydatee = String.valueOf(DateFormat.format("yyyy-MM-dd", horizontalCalendar.getDateAt(position)));
//                Log.i("datetag ",todaydatee);
